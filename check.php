...
<?php include_once 'include/connect.php';?>
	...
	<div class="back_wrapper">
 	...
 	?>
		<a href="enter.php"><div class="button" id="register_button">
			Home
		</div></a>
	<?php } ?>
    </div>
...
<div id="livesearch"></div>
	...
	function showResult() {
	  ...
	  xmlhttp.open("GET","livecheck.php?stream="+stream+"&city="+city+"&school="+school+"&st_name="+st_name+"&st_register="+st_register+"&st_class="+st_class+"&st_activity="+st_activity,true);
	  xmlhttp.send();
	}

	function addPresentStatus(id){
		var address = document.getElementById('st_address_'+id).value;
	    ...
	    // code for IE7+, Firefox, Chrome, Opera, Safari
		  ...
		  xmlhttp.open("GET","update.php?id="+id+"&address="+address,true);
		  xmlhttp.send();
	}
	</script>
